...
public:
    ...
    int mosi_pin, int miso_pin, int sclk_pin, int cs_pin;
    ...
    bool init(int mosi_pin_,int miso_pin_,int sclk_pin_,int cs_pin_) {
...
void BitBangSPI::initGPIO() {
    ...
    if (!gpio.init(mosi_pin_,miso_pin_,sclk_pin_,cs_pin_)) {
